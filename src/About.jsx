        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="md:w-2/3">
            ...
            <p className="text-gray-600 mb-6">
              Hi, I'm Md. Sakibul Alam Patwary, a passionate developer with
              expertise in web development, Artificial Intelligence, software
              applications, and game development. I love building innovative
              solutions that combine creativity and technology. My journey in
              programming has led me to work on diverse projects, from
              full-stack web applications to indie mobile games published on the
              Play Store.
            </p>
            <h3 className="text-2xl font-semibold text-gray-900 mb-4">
              My Skills
